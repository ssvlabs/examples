import { ParticipantFetcher, Network, Ed25519CryptoService } from '../../protocol_interfaces'
...
export const testingKeyPair: Map<number, { publicKey: Uint8Array; privateKey: Uint8Array }> = new Map<
  number,
...
export async function testingSignedVote(
