...
import { generateEd25519KeyPair } from '../../opt_in_data'
import { Network, Ed25519CryptoService } from '../../protocol_interfaces'
import { Vote, SignedVote, ProtocolParticipant, Slot } from '../../protocol_types'
