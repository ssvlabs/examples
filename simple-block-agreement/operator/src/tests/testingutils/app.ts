...
export const TestingBApp: BApp = {
  ...
  tokens: [{ token: 'SSV', sharedRiskLevel: 2, significance: 2 }],
...
export const Testing4Strategies: Strategy[] = [
  ...
  },
  {
    ...
    tokens: [{ token: 'SSV', amount: 150, obligationPercentage: 0.2, risk: 1.2 }],
    validatorBalance: 64,
  },
  {
    id: 4,
    ...
    tokens: [{ token: 'SSV', amount: 300, obligationPercentage: 0.2, risk: 1.2 }],
