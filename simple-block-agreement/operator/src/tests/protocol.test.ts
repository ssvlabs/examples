...
import { mockNetwork, mockParticipantFetcher, testingKeyPair1, testingKeyPair, equalSignedVotes, testingSignedVote, testingHash1, testingSlot1, testingSlot2, testingHash2 } from './testingutils/protocol'; // Adjust the import path as necessary
...
describe('ParticipantState', () => {
    ...
    beforeEach(() => {
        ...
        participantState = new ParticipantState(participantID,
            privateKey,
            network,
    ...
    it('should process a vote and store it', async () => {
        ...
        const signedVote = await testingSignedVote(otherParticipant, testingSlot1, testingHash1, testingKeyPair.get(otherParticipant)!.privateKey);
    ...
    it('reach majority for 2 hashes', async () => {
        ...
        // Process vote from participant 4
        const signedVote4ForHash2 = await testingSignedVote(4, testingSlot2, testingHash2, testingKeyPair.get(4)!.privateKey);
        ...
        const signedVote5ForHash2 = await testingSignedVote(5, testingSlot2, testingHash2, testingKeyPair.get(5)!.privateKey);
    ...
    it('reach majority hash 1, do not receive block, but reach majority for hash 2', async () => {
        ...
        const signedVote2ForHash2 = await testingSignedVote(2, testingSlot2, testingHash2, testingKeyPair.get(2)!.privateKey);
